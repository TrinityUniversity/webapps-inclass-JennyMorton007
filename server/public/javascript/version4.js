console.log("test");
//use functions, not classes, it's easier
...
class LoginComponent extends React.Component{
    ...
    login(e){
        ...
        if(data) {
            ...
            this.setState({ loginName:"",loginPass:"",loginMessage: "Login Failed",createMessage:"" });
        }
        });
    }
    createUser(e){
        ...
        if(data) {
            ...
            this.setState({ createName:"",createPass:"",createMessage: "User Creation Failed",loginMessage:""});
        }
        });
    }
    changeHandler(e){//vv [key]:value
...
class TaskListComponent extends React.Component{
    constructor(props){
        super(props);
        this.state={newTask:"",taskMessage:"",tasks:[]};
    }
    componentDidMount(){
        this.loadTasks();
    }
